...
export default function Cards() {
  function Cateogry({ name, image, path }) {
    ...
    return (
      <div
        className="bg-[#238b45] backdrop-blur-sm opacity-100 border border-gray-200 rounded-2xl shadow-md inline-block p-3 px-5 text-center transition hover:shadow-md hover:scale-[1.02] flex flex-col items-center justify-between w-full max-w-[300px]"
        onClick={() => navigate(path)}
      >
        <a href="#">
          <img className="rounded-4xl" src={image} alt={name} />
        </a>
        <div className="p-5">
  ...
  return (
    <div className="pt-10 w-[95%] m-auto max-w-7xl grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 justify-items-center">
      <Cateogry
        name="SNACKS"
