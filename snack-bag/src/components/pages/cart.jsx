...
function Cart() {
  ...
  const handlePayment = async () => {
    const options = {
      key: "rzp_test_NdIUXp3nJYVmif", // Replace with your Razorpay key
      ...
      handler: async function (response) {
        ...
        const userId = "aae8c61c-1ce4-4a1e-95b1-f2b80d665c51"; // Replace dynamically if needed
    ...
    >
      <div className="md:w-full w-[400px] rounded-xl bg-gradient-to-r from-[#050505] to-[#3c3c3c] mx-auto flex flex-col h-screen mt-4 pl-3 pr-3 mb-4">
        ...
        <div className="flex-grow overflow-y-auto h-150">
          {isCartEmpty ? (
            <div className="text-xl text-[#ECD9BA] text-center mt-10">
              Your cart is empty!
            </div>
          ) : (
        ...
        <div className="mt-3 bg-[#238b45] opacity-90 rounded-3xl p-4 mb-3 shadow-md border-2 border-[#ECD9BA]/90">
          ...
          <div className="flex items-center justify-center w-full">
            <div className="text-white px- py-2 rounded-lg">
              <button
                className={`text-[#ECD9BA] bg-black border border-[#ECD9BA]/50 rounded-lg p-2 outline-none ${isCartEmpty ? 'cursor-not-allowed opacity-50' : ''}`}
