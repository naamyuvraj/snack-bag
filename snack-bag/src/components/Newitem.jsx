        ...
        <div className="mt-3">
          {stock > 0 && quantity === 0 ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-2 py-1 text-sm font-medium text-[#ECD9BA] bg-[#ECD9BA]] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 border border-[#ECD9BA]"
            >
              Add
            </button>
          ) : quantity > 0 ? (
